...
export class PainelAgendamento extends HTMLElement {
    ...
    render() {
        this.innerHTML = `
            ...
            <!-- Modal Interno para Captura de Dados da Fila -->
            <div id="modalFilaEspera" class="modal-overlay hidden">
                <div class="custom-modal" style="max-width: 500px;">
                    ...
                    <h3 class="modal-title">Confirmar Fila de Espera</h3>
                    ...
                    <div class="form-floating-custom mb-3 text-start">
                        <label class="form-label">Dia desejado</label>
                    ...
                    <div class="d-flex gap-2">
                        <button class="btn btn-secondary rounded-pill w-100" id="btnFecharFila">Cancelar</button>
                        <button class="btn-confirmar w-100" id="btnConfirmarFilaFinal">Confirmar Fila</button>
                    </div>
                </div>
            </div>

            <!-- MODAL DE SUCESSO INTEGRADO (Substitui o modal-alerta externo)[cite: 4, 5] -->
            <div id="modalSucessoInterno" class="modal-overlay hidden">
                <div class="custom-modal">
                    <img src="/assets/Images/logo-care-plus.png" alt="Care Plus" class="modal-logo">
                    <h3 class="modal-title" id="tituloSucesso">Sucesso!</h3>
