export class HeaderDeslogado extends HTMLElement {
    connectedCallback() {
        this.innerHTML = `
            <nav class="navbar navbar-expand-lg bg-white sticky-top shadow-sm" style="border-bottom: 4px solid #3aadde;">
                <div class="container-fluid px-4 px-lg-5">
                    
                    <a class="navbar-brand m-0" href="/index.html">
                        <img src="/assets/Images/logo-care-plus.png" alt="Logo Care Plus" height="60" onerror="this.style.display='none'; this.insertAdjacentHTML('afterend', '<span style=\\'font-weight:bold; color:#3aadde;\\'>CARE PLUS</span>');">
                    </a>
                    ...
                    <div class="collapse navbar-collapse" id="menuPrincipal">
                        ...
                        <div class="d-flex align-items-center">
                            <a class="d-flex align-items-center text-decoration-none" href="/assets/Pages/Login/Base.html" style="background-color: #92C444; border-radius: 25px; padding: 4px 4px 4px 20px; transition: 0.3s;">
...
// Registro rigoroso do componente
